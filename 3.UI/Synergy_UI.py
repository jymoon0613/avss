...
def update(step):
    ...
    global params_now, n_used, current_data, stream_data
    ...
    if toggle.active:
        ...
        pred = pred * (c_max - c_min) + c_min
        
        params_now[0], params_now[1], params_now[2], params_now[3], params_now[4], params_now[5], _, _, _ = optimize(pred, params_now, n_used)
        x1_target, x2_target, x3_target, x4_target, x5_target, tap_target, cap_target, cost, n_used = optimize(pred, params_now, n_used)
